        ...
        <SectionPanel>
          ...
          {siblingAreas.length > 0 && (
            <div className="mt-5 flex flex-wrap items-center gap-2">
              ...
              <span className="rounded-xl border border-black bg-black px-3 py-1.5 text-xs font-bold !text-white text-white shadow-2xs">
              ...
              {siblingAreas.map((area) => (
                <Link
                  ...
                  className="rounded-xl border border-neutral-300 bg-neutral-100 px-3 py-1.5 text-xs font-bold !text-black text-black transition hover:bg-black hover:!text-white hover:text-white hover:border-black cursor-pointer shadow-2xs"
                >
                  {area.name}
                </Link>
              ))}
